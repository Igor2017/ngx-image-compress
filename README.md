...
Я изменил правило сжатия:
  - вместо задания процента изменения, я решил задавать конкретный размер квадратного изображения в пикселах
    (например, я захотел аватарку пользователя ужать перед сохранением в базе данных до пвзмера 80х80).
